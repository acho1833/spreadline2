...
/**
 * SpreadLine Demo Page - Using Fixed Backend API (nodeFetchSpreadLine3)
 *
 * This demo fetches data from /api/nodeFetchSpreadLine3 which has the path generation bug fixed.
...
function SpreadLineDemo() {
  // Fetch from the FIXED API endpoint (nodeFetchSpreadLine3)
  const { data, loading, error, setData } = useSpreadLineData('/api/nodeFetchSpreadLine3');
  ...
  useEffect(() => {
    fetch('/api/nodeFetchSpreadLine3')
      .then((res) => res.text())
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-gray-500 text-sm mt-2">Fetching from /api/nodeFetchSpreadLine3</div>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center p-8 bg-gray-50 rounded-xl border border-red-500">
          ...
          <div className="mt-4 text-sm text-gray-500">
            Make sure the API endpoint /api/nodeFetchSpreadLine3 is running
          </div>
        </div>
      </div>
    );
