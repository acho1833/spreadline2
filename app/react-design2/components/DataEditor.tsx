...
// Simplified data editor for quick property changes
...
export function QuickEditor({ label, value, min, max, step = 1, onChange }: QuickEditorProps) {
  return (
    <div className="flex items-center gap-3">
      ...
      />
      <span className="text-cyan-400 font-mono text-sm w-12 text-right">{value}</span>
    </div>
  );
}
