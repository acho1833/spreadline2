...
/**
 * Technical Design Document v4 - SpreadLine
 *
 * Improvements from v3:
 * - Corrected anatomy annotations with proper positioning
 * - Detailed block expansion explanation (research topic space, not citation-centered)
 * - Removed Non-Functional Requirements section
 * - Uses updated screenshots
 */
...
export default function TechnicalDesignDocumentV4() {
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-black text-white">
                Technical Design Document <span className="text-yellow-300">v4</span>
              </h1>
              <p className="text-blue-100 text-sm">SpreadLine - Complete Reference</p>
            </div>
  ...
  "blocks": [{
    ...
    "outline": { "left": "M63.22,268...", "right": "M62.59,268..." }
            ...
            <div className="mt-12 pt-8 border-t border-gray-200 text-center text-gray-500 text-sm">
              <p className="font-semibold">Technical Design Document v4 - SpreadLine</p>
