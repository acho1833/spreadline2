...
export function createStyleElementFromCSS(): SVGStyleElement {
  ...
  style.textContent = `
    ...
    .storyline-hover { stroke-width: 4px; }
    .storyline-dehighlight { opacity: 0.1; }
    .storyline-arc-dehighlight { opacity: 0.15; }
    .storyline-label-dehighlight { opacity: 0; }
    .storyline-pin { opacity: 1; }
    ...
    /* Points */
    .points { stroke: #000; stroke-width: 0.5px; }

    /* Text */
    .text-display { font-weight: bold; font-size: 14px; }
    .stroked-text { stroke: white; stroke-width: 3px; paint-order: stroke; }
